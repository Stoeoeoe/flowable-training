 ...
 */
class FlowableEngageTrainingDefaultEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    private static class Loader {
        ...
        void load(String location, PropertySourceLoader loader) {
            try {
                ...
                String propertyResourceName = "flowableEngageTrainingConfig: [" + location + "]";
